      ...
      <head>
        ...
        <main className="max-w-4xl mt-10 px-6 md:px-10">
          ...
          <p className="mb-4">
            ...
            information when you visit asyncawake.com or use our assistant-bot
            services.
          </p>
          ...
          <p className="mb-4">
            ...
            <br />- <strong>Assistant-Bot Data</strong>: Chat transcripts or
            preferences from interactions with our clients’ assistant-bots.
          ...
          <p className="mb-4">
            ...
            <br />- Deliver and improve our assistant-bot services.
          ...
          <p className="mb-4">
            ...
            analytics.
            <br />- <strong>Clients</strong>: Relevant assistant-bot data to fulfill
            their services.
